    ...
    public partial class MainForm : Form
    {
        ...
        private void btnLoadXml_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                // АВТОМАТИЧНЕ ЗАПОВНЕННЯ СПИСКІВ ПРИ ЗАВАНТАЖЕННІ ФАЙЛУ
                PopulateFilters();
            }
        }

        // Метод, що витягує дані з файлу і кладе їх у ComboBox
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            // Зчитуємо значення з випадаючих списків (Text дозволяє і введення, і вибір)
